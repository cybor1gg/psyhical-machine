...
export default function MenuPage() {
  ...
  return (
    <div ref={rootRef} style={{ position: "relative", width: "100vw", height: "100vh", minHeight: 500, overflow: "hidden", display: "flex", flexDirection: "column", background: "radial-gradient(130% 100% at 50% -25%, #1a1f33 0%, #0a0c14 55%, #06070b 100%)", fontFamily: "'DM Sans', Helvetica, Arial, sans-serif", color: "#f0ece4", touchAction: "none", userSelect: "none" }}>
      ...
      <div style={{ position: "absolute", inset: "-25%", pointerEvents: "none", opacity: 0.55, background: "conic-gradient(from 0deg, rgba(217,178,106,0) 0deg, rgba(217,178,106,.14) 42deg, rgba(217,178,106,0) 92deg, rgba(123,63,212,.12) 205deg, rgba(217,178,106,0) 305deg)", animation: "mtSpin 26s linear infinite" }} />
      <div style={{ position: "absolute", inset: 0, pointerEvents: "none", backgroundImage: "radial-gradient(circle at 20px 20px, rgba(217,178,106,.20) 2px, transparent 3px), radial-gradient(circle at 90px 70px, rgba(255,255,255,.12) 1.5px, transparent 3px), repeating-linear-gradient(64deg, rgba(255,255,255,.03) 0 1px, transparent 1px 92px)", backgroundSize: "140px 140px, 180px 180px, auto", animation: "mtStars 36s linear infinite, mtTwinkle 3.6s ease-in-out infinite" }} />
      <div style={{ position: "absolute", inset: 0, pointerEvents: "none", opacity: 0.5, backgroundImage: "radial-gradient(circle at 55px 110px, rgba(240,217,154,.16) 1.5px, transparent 3px), radial-gradient(circle at 130px 40px, rgba(150,170,255,.13) 1px, transparent 2.5px)", backgroundSize: "200px 200px, 240px 240px", animation: "mtStars2 48s linear infinite, mtTwinkle 5.2s ease-in-out infinite reverse" }} />
      <div style={{ position: "absolute", top: "18%", left: 0, width: 130, height: 2, borderRadius: 2, pointerEvents: "none", background: "linear-gradient(90deg, rgba(240,217,154,0), rgba(240,217,154,.8))", filter: "drop-shadow(0 0 6px rgba(240,217,154,.8))", animation: "mtComet 11s ease-in 2s infinite" }} />
      {orbs.map((o, i) => (
        <div key={i} style={{ position: "absolute", left: o.left, top: o.top, width: o.size, height: o.size, borderRadius: "50%", background: o.fill, filter: "blur(30px)", animation: `mtDrift ${o.dur} ease-in-out infinite`, animationDelay: o.delay, pointerEvents: "none" }} />
      ))}
      <div style={{ position: "absolute", top: "-20%", left: "12%", width: "76%", height: "140%", pointerEvents: "none", filter: "blur(70px)", background: "radial-gradient(46% 50% at 50% 50%, rgba(240,217,154,.11), rgba(240,217,154,.05) 45%, rgba(240,217,154,0) 78%)", animation: "mtSweep 10s ease-in-out infinite alternate" }} />
