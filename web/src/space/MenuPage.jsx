...
export default function MenuPage() {
  ...
  return (
    <div ref={rootRef} style={{ position: "relative", width: "100vw", height: "100vh", minHeight: 500, overflow: "hidden", display: "flex", flexDirection: "column", background: "radial-gradient(130% 100% at 50% -25%, #1a1f33 0%, #0a0c14 55%, #06070b 100%)", fontFamily: "'DM Sans', Helvetica, Arial, sans-serif", color: "#f0ece4", touchAction: "none", userSelect: "none" }}>
      ...
      <div className="mt-stars" style={{ position: "absolute", inset: "-60%", pointerEvents: "none", backgroundImage: "radial-gradient(circle at 20px 20px, rgba(217,178,106,.20) 2px, transparent 3px)", backgroundSize: "140px 140px", animation: "mtTile140 36s linear infinite, mtTwinkle 3.6s ease-in-out infinite", willChange: "transform" }} />
      <div className="mt-stars" style={{ position: "absolute", inset: "-60%", pointerEvents: "none", backgroundImage: "radial-gradient(circle at 90px 70px, rgba(255,255,255,.12) 1.5px, transparent 3px)", backgroundSize: "180px 180px", animation: "mtTile180 36s linear infinite, mtTwinkle 3.6s ease-in-out infinite", willChange: "transform" }} />
      <div className="mt-stars2" style={{ position: "absolute", inset: "-60%", pointerEvents: "none", opacity: 0.5, backgroundImage: "radial-gradient(circle at 55px 110px, rgba(240,217,154,.16) 1.5px, transparent 3px)", backgroundSize: "200px 200px", animation: "mtTile200 48s linear infinite, mtTwinkle 5.2s ease-in-out infinite reverse", willChange: "transform" }} />
      <div className="mt-stars2" style={{ position: "absolute", inset: "-60%", pointerEvents: "none", opacity: 0.5, backgroundImage: "radial-gradient(circle at 130px 40px, rgba(150,170,255,.13) 1px, transparent 2.5px)", backgroundSize: "240px 240px", animation: "mtTile240 48s linear infinite, mtTwinkle 5.2s ease-in-out infinite reverse", willChange: "transform" }} />
